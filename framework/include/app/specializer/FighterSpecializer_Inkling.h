...
namespace app {
    namespace FighterSpecializer_Inkling {
		...
		u64 get_ink_work_id(app::Fighter *, u64) asm("_ZN3app26FighterSpecializer_Inkling15get_ink_work_idEj") LINKABLE;
		...
		u64 check_roller_ground(app::Fighter *, const Vector2f*, const Vector2f*, Vector2f&, Vector2f&, bool) asm("_ZN3app26FighterSpecializer_Inkling19check_roller_groundERNS_7FighterERKN3phx8Vector2fES6_RS4_S7_b") LINKABLE;
		...
		u64 change_ink(app::Fighter *) asm("_ZN3app26FighterSpecializer_Inkling10change_inkERNS_7FighterEf") LINKABLE;
    }
}
